...
Regional skew coefficients are necessary to determine flood frequency following [Bulletin 17C](https://pubs.usgs.gov/publication/tm4B5) guidelines. The goal of FFA_regional-skew is to estimate a regional skew coefficients for stream gages in the Northwestern Great Plains and northern portion of the High Plains sections of the Great Plains within southeastern Montana, eastern Wyoming, northeastern Colorado, and the western portions of Nebraska and the Dakotas.
