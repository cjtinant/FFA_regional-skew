...
- `R/03b_make_macrozone_lut.R`
- `R/03c_make_macrozone_layer.R`
...
| 3.2  | Create macrozone layer                                  | \[X\]  |
| 3.3  | Create zonal covar summaries at the macroregional scale | \[ \]  |
...
- Reflected update in `CHANGELOG.md` and `log_README.Rmd`

### Milestone 3.2 Summary:

- Implemented `03b_make_macrozone_lut.R` to create
...
Milestone 3.1 established a clean, traceable foundation for covariate
