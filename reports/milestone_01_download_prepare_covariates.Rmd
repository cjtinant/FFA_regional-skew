...
├── data/
    ...
    ├── processed/                # Cleaned, derived datasets
        ├── ecoregions/
        |       ├── us_eco_levels.gpkg    # US Ecoregions Levels 1-4
        ├── koppen_climate/
    ...
    ├── raw/                      # Unmodified input data
        ...
        ├── koppen_climate/       # Köppen Geiger climate rasters
        |       ├── 1901_1930
        |       ├── 1931_1960
        |       ├── 1961_1990
        |       ├── 1991_2020
...
-     Saves output to:
-         mupolygon_statsgo2_great_plains.csv,
-         mapunit_statsgo2_great_plains.csv,
-         (WGS84): mupolygon_statsgo2_great_plains.gpkg
-         (EPSG:5070): mupolygon_statsgo2_albers.gpkg
