...
|      ├── 01a_download_us_ecoregions.R   # Download US Ecoregions data
|      ├── 01b_download_gage-data.R`      # Download raw `peakflow gage` data
|      ├── 01c_download_nhdplus_v21_flowlines.R   # Download NHDPlusV2.1 
|      |                                          # flowlines and catchments
|      ├── 01d_download_nhdplus_hr_flowlines.R    # Download NHDPlus HR
|      |                                          # flowlines
|      ├── 01e_download_nhdplus_hr_catchments.R   # Download NHDPlus HR
|      |                                          # catchment boundaries
|      ├── 01f_download_koppen-geiger_climate.R   # Download, processes, and
|      |                                          # prepare Köppen Geiger
|      |                                          # climate rasters
|      ├── 01g_download_plant-hardiness-zone-map.R   # Download and processes
                                                     # climate rasters
...
| 0.5.5.1   | Validate spatial coverage, resolution, and CRS          |  [X]   |
| 0.5.5.2   | Inspect folders for untracked or duplicate files        |  [ ]   |
