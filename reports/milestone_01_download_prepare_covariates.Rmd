...
### Step 0.5.2 — Update folder structure for utils/
...
**Result (After):** Created reusable, well-scoped functions in utils/ and stored them in domain-specific folders (like metadata/, spatial/, qaqc/) will make your scripts easier to maintain, debug, and teach from.

-   Backed up entire project 
-   Made folders to organize scripts
