...
This table links each major `R/` script folder to its corresponding milestone for clarity and traceability.
...
Milestone 00 completed on 2025-04-20 and tagged as
`v0.3-structure-refactor`.

Next steps: - Continue script renaming for `R/03_covariates/`,
`R/04_modeling/`, and `R/05_eval/` - Begin planning Milestone 01:
Exploratory Covariate Analysis and Model Selection

------------------------------------------------------------------------

## ✅ Milestone 01 – Raw Data Download

**Scripts:** - (now) `R/01_download/01_get_spatial_data.R` - (now)
`R/01_download/02_get_gage_data.R`

**Purpose:**\
Automate download of raw peak flow data, site info, and relevant spatial
layers from NWIS and WQP.
