...
### Step 0.3.7  - ** Updated ** Move steps to milestone_01

-   **Action:** Created sub-issue v0.4 of Milestone 00 (this milestone). Moved steps related to downloading scripts to Milestone 01. Closed sub-issue v0.4.

-   **Reason/Before:** Identified a need identify covariates, and create and validate covariate metadata. 

-   **After:** Better organized and modularized project workflow.

### Step 0.3.8  - Update GitHub Milestone and Issue
### Step 0.3.9  - Document Final Changes this Rmd
### Step 0.3.10 - Document changes in README
### Step 0.3.11 - Push to .git and tag commit
