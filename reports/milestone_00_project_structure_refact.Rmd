...
# Ver.0.3 -- Refactored project structure and added macrozone covariates
...
# Ver.0.4 -- Update R/01_download folder

## Update checklist
| Step | Task                                                         | Status |
|:--------:|----------------------------------------------------------|:------:|
| 0.4.1    | Update 0.3 file structure in this Rmd and in FFA_regional_skew | [X] |
| 0.4.2    | Identify and document covariates using `01c_data_dictionary_for_covariates.Rmd` | []    |
| 0.4.3    | Update R/01_download/ folder structure                   | []    |
| 0.4.4    | Create downloads scripts for each domain and covariate   | []    |
| 0.4.5    | Create README-style notes for script in milestone folder | []   |
| 0.4.6    | Rename scripts for clarity and consistency e.g., 03a_, 03b_ | []  |
| 0.4.7    | Validate chunk headers in .Rmd files ({r name, eval=} )  | []    |
| 0.4.8    | Knit milestone and data dictionary .Rmd files to PDF     | []    |
| 0.4.9    | Add file headers / docstrings to all scripts e.g. author, purpose, date| []   |
| 0.4.10   | Document changes in 01_download README.Rmd               | []    |
| 0.4.11   | Add reference links to documentation e.g., PRISM, USGS, NLCD | [] |
| 0.4.12    | Create README-style notes for each R milestone folder    | []    |
...
### Step 0.4.1 — Identify and document covariates
