...
- Standardized header scripts in `R/01_downloads`, `R/02_clean_verify`, and
`R/utils`.

- Integrated `notes/future_milestones` into `notes/script-notes_and_developer-log`.

- Emptied `sandbox/` moving a few files to `notes/to_process`.

- Organized `reports/` by moving abstract and posterdown files related to the
pilot project to `reports/20250415_pilot` and moving milestone reports to
`reports/milestones`.

- Organized `results/` by moving files related to the pilot project to
