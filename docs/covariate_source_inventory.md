...
These tables list datasets used in the regional skew estimation project.
All datasets are publicly available, spatially referenced, and selected
for their hydrologic relevance.

See ‘Skew Covariates Metadata Schema’ and
spatial_data_preparation_checklist.md for descriptions
...
USGS NHDPlus Catchments \| [USGS](https://www.usgs.gov/) \| `.shp` \|
Check \| check\|  
NLCD Land Cover 2016 \| [MRLC](https://www.mrlc.gov/) \| `.tif` \|
Needed \| check \|  
NED Elevation \| [National Map](https://apps.nationalmap.gov/) \| `.tif`
\| Needed \| ned_elevation \|  
...
USGS NHDPlus Catchments \| NAD83 \| Check \| nhd_catchments \| Use V2 or
HR variant \|

NLCD Land Cover 2016 \| 30 m, Albers \| 2016 \| nlcd_landcover_2021 \|
Clip to HUC region \|  
NED Elevation \| 1/3 arc-second \| 2020+ \| ned_elevation \| Reproject
to match others \|
