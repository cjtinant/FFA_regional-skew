...
Additional covariate information is located in the [Skew Covariates Metadata Schema](data/meta/covariates_metadata_split/covariates_covariate_metadata_schema.csv).
