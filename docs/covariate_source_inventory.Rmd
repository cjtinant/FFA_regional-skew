...
All datasets are publicly available, spatially referenced, and selected for
their hydrologic relevance. 
...
above. Values range from "00 — Not Started" to "10 — Used in Modeling".
