# ==============================================================================
# Script Name:      03h_covar_prep_NLCD.R
...
#                  A potential root cause is cubic vs bilinear resampling
#                  created non-legend class codes. 
#
# Generalized Workflow:
# 1. Make and save NLCD lookup table.
# 2. 
