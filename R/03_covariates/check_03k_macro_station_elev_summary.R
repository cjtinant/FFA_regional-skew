...
# Purpose:          Calculate mean elevation from gage locations
# Author:           Charles Jason Tinant with ChatGPT 5 thinking
# Date Created:     2025-10-13
# Last Updated:     2025-10-13
#
# Changelog:
#  2025-10-13      Initial script
#
# Generalized Workflow:
#  1. Load and check stations and zones.
...
# st_layers(gage_path)
layer_name <- "gage_covars"

gages <- st_read(gage_path, layer = layer_name, quiet = TRUE)
...
# ------------------------------------------------------------------------------
# 3. Clean / update gages 
# ------------------------------------------------------------------------------
# --- check variable names ---
names(gages)

gage_skim <- skimr::skim(gages_raw)

gages <- gages_raw %>%
  select(-in_macro)

# site_no"        "station_nm"     "lat_dd"         "long_dd"        "skew_lp3"      
#  [6] "huc_cd"         "coord_datum_cd" "tier"           "wtsd_area_sqkm" "alt_m"         
# [11] "crs_in"         "in_macro"       "macro_id"       "region_name"    "macrozone"     
# [16] "geom"     
