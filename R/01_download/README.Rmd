...
- [ ] Add summary metadata export for all download outputs
- [ ] Cross-link each script to relevant milestone reports
- [ ] Auto-update table using a simple `list.files()` + metadata parser
