...
# Output:
# - Clean Ecoregion Level I - Level IV clipped to CONUS and in a common CRS in
...
zip_url <- paste0(
  ...
  "/ORD/Ecoregions/cec_na/na_cec_eco_l2.zip"
)
meta_url <- paste0(
  "https://dmap-prod-oms-edc.s3.us-east-1.amazonaws.com",
...
meta_url <-
  "https://dmap-prod-oms-edc.s3.us-east-1.amazonaws.com/ORD/Ecoregions/cec_na/NA_CEC_Eco_Level3.htm"
lyr_url <-
...
# 3. Clip Levels I–III to the spatial extent of Level IV (CONUS boundary)
# ------------------------------------------------------------------------------
# --- Merge Level 4 to prepare for clip ---
level4_merged <- st_union(level4_albers)

# --- Clip Level 1 to 3 ecoregions by Level 4 extent ---
...
# ------------------------------------------------------------------------------
# 4. Validate and repair geometries and coerce to consistent geometry types
# ------------------------------------------------------------------------------
