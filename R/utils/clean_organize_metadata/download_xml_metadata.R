...
# MODIS data includes metadata from two sources: embedded HDF metadata and
# external ECS (XML) metadata. The HDF metadata, similar to ASTER files,
# contains global and dataset-specific attributes, including information about
# the granule. The external ECS metadata, provided as an .met file, is a subset
# of the HDF metadata in XML format. This external metadata is delivered with
# the MODIS product and is useful for understanding the data.
