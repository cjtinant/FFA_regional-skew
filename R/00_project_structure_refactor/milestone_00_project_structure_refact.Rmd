...
---
title: "00_refactor_log – File & Folder Reorganization Notes"
...
|      |   milestone + domain + covariate + source                   | [*]    |
| 0.3.8    | Tag this commit in Git as v0.3-structure-refactor       | [*]    |
| 0.3.9    | Create GitHub Milestone and Issue                       | []    |
| 0.3.10    | Document changes in this .Rmd                          | []    |
| 0.3.11    | Document changes in README.Rmd                         | []    |

* Need to document these steps

## Ver.0.4 -- Update R/01_download
| Step | Task                                                          | Status |
|--------------|-------------------------------------------------------|-------|
| 1    | Create downloads scripts for each domain and covariate        | []   |
| 2    | Create README-style notes for script in milestone folder      | []   |
| 3    |           | []   |
| 4    |         | []   |
| 5    |                  | []   |
| 6    | | []   |
