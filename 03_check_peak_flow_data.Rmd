...
# revise below
peak_data_na <- peak_data_gt_20 %>%
  filter(is.na(peak_va))

test <- peak_data_gt_20 %>%
...
check_flag_disch_lt_recorded <- peak_data_gt_20 %>%
  filter(peak_cd == "4")

check_flag_unkn_yr <- peak_data_gt_20 %>%
  filter(peak_cd == "A")

check_flag_unkn_mo <- peak_data_gt_20 %>%
  filter(peak_cd == "Bm")

check_flag_unkn_dy <- peak_data_gt_20 %>%
  filter(peak_cd == "Bd")

check_flag_opportunistic <- peak_data_gt_20 %>%
  filter(peak_cd == "O")
