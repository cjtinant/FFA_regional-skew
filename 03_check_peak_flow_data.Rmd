...
# check duplication issue -- peak_data_gt_20
...
peak_data <- anti_join(peak_data_unreg, na_data,
                       by = join_by(site_no, peak_dt, peak_va))

# check that the count is true
check_count <- nrow(peak_data_unreg) == nrow(peak_data) - nrow(na_data)

# clean up Global Environment
write_csv(peak_data_na, "data_output/peak_data_na_vals.csv")
rm(peak_data_unreg,
   peak_data_na,
   sites_na)
...
# clean up Global Environment
write_csv(peak_data_na, "data_output/peak_data_na_discharge.csv")
rm(peak_data_unreg,
   peak_data_na,
   sites_na)
